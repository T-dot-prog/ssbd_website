...
This application consolidates two critical services into a single, seamless platform:
...
Accessing your information is fast and intuitive. The application uses your unique identifier as the sole key for all services:

1.  **Identify Your Need:** When you launch the app, look to the sidebar menu on the left side of the screen.
2.  **Select a Service:** Click on the option that corresponds to your goal: "Profile Verification" or "Certificate Download." The main display area will instantly update to show the chosen portal's interface.
3.  **Authentication:** In the input field provided on the main screen, accurately enter your official and complete SSBD Participant ID. This ID serves as your security key for accessing your data.
4.  **Instant Result:** Click the action button (e.g., "Verify" or "Download"). The system instantly processes your ID to either display your verified profile details or securely initiate the download of your official certificate.
...
1.  Clone the repository:
    ```bash
    git clone https://github.com/your-username/ssbd-participant-portal.git
    ```
